...
bool LandPaper::ActionType(int8 atype)
{
    return atype == action_type;
}

SEAT_T LandPaper::getPlayId()const
{
    return play_id;
}

bool LandPaper::outPress(SEAT_T handle_id, CARD_T *gcards, int8 size, CARD_TYPE ctype, int tsize)
{
    bool is_ok = false;
